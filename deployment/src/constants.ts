...
export const armConstants = {
    ...
    //
    //    https://raw.githubusercontent.com/Azure/azure-iot-pcs-device-simulation/<PCS_RELEASEVERSION>/vm-setup
    //
    ...
    // setup this path value is used to download a VM setup script from GitHub.
