...
while [ "$#" -gt 0 ]; do
    case "$1" in
        --solution-setup-url)      PCS_SOLUTION_SETUP_URL="$2" ;; # e.g. https://raw.githubusercontent.com/Azure/azure-iot-pcs-device-simulation/DS-1.0.0/arm-deployment/devicesimulation-nohub
...
REPOSITORY="https://raw.githubusercontent.com/Azure/azure-iot-pcs-device-simulation/${PCS_RELEASE_VERSION}/arm-deployment/devicesimulation-nohub/single-vm"
