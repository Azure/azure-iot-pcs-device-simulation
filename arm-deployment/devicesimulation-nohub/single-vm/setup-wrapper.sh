...
SETUP_SCRIPTS_URL="https://raw.githubusercontent.com/Azure/azure-iot-pcs-device-simulation/${PCS_RELEASE_VERSION}/arm-deployment/devicesimulation-nohub/single-vm/"
