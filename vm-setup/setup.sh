...
while [ "$#" -gt 0 ]; do
    case "$1" in
        ...
        --container-repository-prefix) CONTAINER_REPOSITORY_PREFIX="$2" ;;
    esac
    shift
done
...
DOCKERCOMPOSE_SOURCE="${PCS_SOLUTION_SETUP_URL}/docker-compose.yml"
...
echo "export CONTAINER_REPOSITORY_PREFIX=\"${CONTAINER_REPOSITORY_PREFIX}\""                             >> ${ENVVARS}
